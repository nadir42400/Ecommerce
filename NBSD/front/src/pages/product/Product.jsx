      ...
      <div className="productTop">
        ...
        <div className="productTopRight">
          <div className="productInfoTop">
            ...
            <span className="productName">{product.full_name}</span>
          </div>
      ...
      <div className="productBottom">
        <form className="productForm">
          <div className="productFormLeft">
            ...
            <input name="full_name" type="text" placeholder={product.full_name} onChange={handleChange} />
            <label>Product Description</label>
            <input type="text" placeholder={product.details} onChange={handleChange} />
            <label>Price</label>
            <input type="number" placeholder={product.price} onChange={handleChange} />
            <label>In Stock</label>
            <input type="text" placeholder={product.stock} onChange={handleChange} />
            <label>Marque</label>
            <input name="marque" type="text" placeholder={product.marque} onChange={handleChange} />
